...
if __name__=="__main__":
  # We can use this to run this file as a script and test the Preprocessor
    ...
    Prepro = Preprocessor()
    Prepro2 = Preprocessor2(D.data['X_train'], D.data['Y_train'])
 ...
 #   D.data['X_valid'] = Prepro.transform(D.data['X_valid'])
  #  D.data['X_test'] = Prepro.transform(D.data['X_test'])
    ...
    test2 = Prepro2.fit_transform(D.data['X_train'], D.data['Y_train'])
  ...
  #  test2.to_csv( 'PCA1_train.data', index=False, header=False)
